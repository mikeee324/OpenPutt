...
namespace dev.mikeee324.OpenPutt
{
    ...
    public class Scoreboard : UdonSharpBehaviour
    {
        ...
        public void RefreshSettingsMenu()
        {
            ...
            clubAutoHoldCheckbox.sprite = playerManager.golfClub.pickup.AutoHold == VRC_Pickup.AutoHoldMode.Yes ? checkboxOn : checkboxOff;
        }
        ...
        public void OnToggleClubAutoHold()
        {
            if (!Utilities.IsValid(manager) || !Utilities.IsValid(manager.openPutt) || !Utilities.IsValid(manager.openPutt.LocalPlayerManager))
                return;
            ...
            if (!Utilities.IsValid(playerManager.golfClub) || !Utilities.IsValid(playerManager.golfClub.pickup))
                return;
