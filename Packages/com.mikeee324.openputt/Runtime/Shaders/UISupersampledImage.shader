...
// Modified again for OpenPutt to expose the depth test, so palm UI icons can draw over
// world geometry like the rounded rect backgrounds they sit on.
Shader "OpenPutt/UI/SupersampledImage"
{
    Properties
    {
